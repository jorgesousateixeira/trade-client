    ...
    <Fade>
      <div className={publicStyles.root}>
        <div className={publicStyles.mainWrap}>
          <PublicTitle title={t('public.500.title')}></PublicTitle>
          <div className={publicStyles.main}>
            <p>{t('public.500.text')}</p>
            <Link to={RouterFunctions(RouteCodeEnum.Home)}>
              <Button variant="contained" type={'button'} className="btn-primary">{t('public.500.button')}</Button>
            </Link>
          </div>
        </div>
      </div>
